    ...
    return (
        <div className={`fixed top-0 left-0 h-full bg-slate-950 transition-transform transform lg:translate-x-0 lg:relative lg:w-3/12 lg:mr-2 lg:mt-4 rounded-lg z-50 ${isSidebarVisible ? 'translate-x-0' : '-translate-x-full'}`}>
            <ul className="rounded-sm bg-slate-900 text-slate-300 p-4">
                ...
                <Link onClick={hideSidebar} to="/" className="p-2 flex font-family-Raleway duration-200 ease-in font-semibold hover:text-slate-100 duration-500 hover:underline hover:underline-offset-4">
                ...
                <Link onClick={hideSidebar} to="/searchpage" className="p-2 flex font-family-Raleway duration-200 ease-in font-semibold hover:text-slate-100 duration-500 hover:underline hover:underline-offset-4">
            ...
            <ul className="rounded-sm bg-slate-900 text-slate-300 p-4 mt-2">
                <li className="pl-2 flex font-family-Raleway font-semibold">
                    ...
                    <Link onClick={hideSidebar} to="/playlist">
